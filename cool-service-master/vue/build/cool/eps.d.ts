declare namespace Eps {
	interface AiModelEntity {
		...
		/**
		 * 能力 text/image/audio_music/audio_speech/video
		 */
		capability?: string;
	...
	interface ToolboxStudyCategoryEntity {
		/**
		 * ID
		 */
		id?: number;
	...
	interface ToolboxStudyVideoEntity {
		/**
		 * ID
		 */
		id?: number;
	...
	interface AiTemplatePageResponse {
		pagination: PagePagination;
	...
	interface ToolboxStudyCategoryPageResponse {
		pagination: PagePagination;
		list: ToolboxStudyCategoryEntity[];
	}

	interface ToolboxStudyVideoPageResponse {
		pagination: PagePagination;
		list: ToolboxStudyVideoEntity[];
	}
	...
	interface AiTemplate {
		 ...
		 * 分页查询
		 */
		page(data?: any): Promise<AiTemplatePageResponse>;
	...
	interface ToolboxStudyCategory {
		/**
		 * 删除
		 */
		delete(data?: any): Promise<any>;
		 ...
		 * 单个信息
		 */
		info(data?: any): Promise<ToolboxStudyCategoryEntity>;

		/**
		 * 列表查询
		 */
		list(data?: any): Promise<ToolboxStudyCategoryEntity[]>;

		/**
		 * 分页查询
		 */
		page(data?: any): Promise<ToolboxStudyCategoryPageResponse>;
	...
	interface ToolboxStudyVideo {
		 ...
		 * 单个信息
		 */
		info(data?: any): Promise<ToolboxStudyVideoEntity>;

		/**
		 * 列表查询
		 */
		list(data?: any): Promise<ToolboxStudyVideoEntity[]>;

		/**
		 * 分页查询
		 */
		page(data?: any): Promise<ToolboxStudyVideoPageResponse>;
	...
	type Service = {
		...
		ai: { model: AiModel; template: AiTemplate };
		base: {
			coding: BaseCoding;
			comm: BaseComm;
			open: BaseOpen;
		...
		toolbox: {
			...
			studyCategory: ToolboxStudyCategory;
			studyVideo: ToolboxStudyVideo;
			tool: ToolboxTool;
			usage: ToolboxUsage;
		};
