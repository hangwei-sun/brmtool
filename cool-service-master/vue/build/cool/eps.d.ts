declare namespace Eps {
	...
	interface ToolboxPluginPageResponse {
		pagination: PagePagination;
		list: ToolboxPluginEntity[];
	}
	...
	interface ToolboxPlugin {
		 ...
		 * uploadPackage
		 */
		uploadPackage(data?: any): Promise<any>;

		/**
		 * linkTool
		 */
		linkTool(data?: any): Promise<any>;
		 ...
		 * info
		 */
		info(data?: any): Promise<ToolboxPluginEntity>;

		/**
		 * list
		 */
		list(data?: any): Promise<ToolboxPluginEntity[]>;

		/**
		 * page
		 */
		page(data?: any): Promise<ToolboxPluginPageResponse>;
